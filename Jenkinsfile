    ...
    stages {
        ...
        stage('git checkout') {
            steps {
                ...
                git branch: "master", url: 'https://github.com/ayushpratapsingh/spbmavenexample.git'
            }
        }
        ...
        stage('Deploy war') {
            steps {
                deploy adapters: [tomcat9(credentialsId: 'tomcatads', path: '', url: 'http://18.212.217.2:8080/')], contextPath: 'myappm', onFailure: false, war: 'target/*.war'
             }
        }  
